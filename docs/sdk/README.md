# ThoughtSpot Chart SDK - Documentação Completa

Esta seção contém toda a documentação relacionada ao **ThoughtSpot Chart SDK** - framework para criar charts customizados hospedados externamente.
