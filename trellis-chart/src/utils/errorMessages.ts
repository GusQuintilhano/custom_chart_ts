...
export const ERROR_MESSAGES = {
    ...
    INSUFFICIENT_DATA: '<div style="padding: 20px; color: #f59e0b; background: #fffbeb; border: 1px solid #fde68a; border-radius: 6px;"><h4 style="margin: 0 0 10px 0;">⚠️ Dados insuficientes</h4><p style="margin: 0;">É necessário pelo menos 1 dimensão e 1 medida.</p></div>',
