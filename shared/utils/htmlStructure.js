 ...
 */
export function createChartHtmlStructure(fitWidth, fitHeight, chartWidth, chartHeight, secondaryXAxisHtml, secondaryXAxisLabelsHtml, yAxesHtml, dividerLinesBetweenMeasuresHtml, dividerLinesBetweenBarsHtml, referenceLinesHtml, allChartElementsHtml, xAxis, xAxisLabels, backgroundColor = 'transparent') {
    // Container overflow
