 ...
 */
export function valueToY(value, minValue, maxValue, measureRowTop, measureRowHeight) {
 ...
 */
export function calculateMeasureRowTop(measureIdx, topMargin, measureRowHeight, spacingBetweenMeasures) {
 ...
 */
export function calculateLastMeasureRowTop(measureCount, topMargin, measureRowHeight, spacingBetweenMeasures) {
    if (measureCount === 0)
        return topMargin;
 ...
 */
export function calculateBarX(barIdx, leftMargin, barWidth, barSpacing) {
 ...
 */
export function calculateBarCenterX(barIdx, leftMargin, barWidth, barSpacing) {
